				...
				<div class="modal fade" id="resourcesModal" tabindex="-1" role="dialog" aria-labelledby="addroleLabel">
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      <div class="modal-header">
				        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				        <h4 class="modal-title" id="addroleLabel">添加/修改资源</h4>
				      </div>
				      <div class="modal-body">
		...
		table = $('#datatable').DataTable( {
			...
			columnDefs:[{
                ...
                render: function (data, type, row, meta) {
                    ...
                    '<security:authorize buttonUrl='/role/editResources.do'><a type="button" class="btn btn-success btn-default" href="javascrip:;" onclick=editResources(' + row.id + ') >修改</a></security:authorize></p>';
                }
            },
